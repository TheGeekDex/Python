...
if __name__ == "__main__":
	while True:
		string = input("Choose from below options : [1,2]\n1. Convert text to binary\n2. Convert binary to text\n3. Cancel\n: ")
		if string == '1':
			print("RESULT :\033[92m",text_to_binary(input("Enter the string to convert: ")),end="\033[0m\n\n")
		elif string == '2':
			print("RESULT :\033[92m",binary_to_text(input("Enter the binary string to convert: ")), end="\033[0m\n\n")
		elif string == '3':
			exit()
		else:
